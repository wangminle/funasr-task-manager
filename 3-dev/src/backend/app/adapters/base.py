...
class BaseAdapter(ABC):
    ...
    @abstractmethod
    async def transcribe(self, host: str, port: int, audio_path: str, profile: MessageProfile, *, use_ssl: bool = True, ssl_verify: bool = False, timeout: float = 300.0) -> ParsedResult: ...
