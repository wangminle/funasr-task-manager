...
> - `7-data/outputs/e2e/`、`3-dev/src/frontend/test-results/`、`3-dev/src/frontend/playwright-report/` 已按本地测试工件处理，不应提交 Git
...
1. 下午通过 Agent 浏览器自动化完成一次真实 smoke，产物位于：`7-data/outputs/e2e/20260326-162641/`
2. 晚上通过仓库内正式 Playwright 工程完成首次 smoke，产物位于：`7-data/outputs/e2e/20260326-191950/`
3. 修复路径与结果映射问题后，再次通过正式 Playwright 工程回归，最新产物位于：`7-data/outputs/e2e/20260326-192816/`
4. 使用重型 `standard` 批次回归，结果为 4/5 成功、1 个大 mp3 在 30 分钟上限超时，产物位于：`7-data/outputs/e2e/20260326-193618/`
5. 使用正式 `remote-standard` 批次回归，结果 5/5 成功，产物位于：`7-data/outputs/e2e/20260326-205431/`
...
- `7-data/outputs/e2e/20260326-205431/run-summary.json`
- `7-data/outputs/e2e/20260326-205431/run-summary.md`
...
1. 把 trace 文件也复制归档到 `7-data/outputs/e2e/<timestamp>/`
